...
if(isset($_SESSION['key'])){
	if(@$_GET['fdid'] && $_SESSION['key']=='admin1234') {
		$id=@$_GET['fdid'];
...
//delete user
if(isset($_SESSION['key'])){
	if(@$_GET['demail'] && $_SESSION['key']=='admin1234') {
		$demail=@$_GET['demail'];
...
//remove quiz
if(isset($_SESSION['key'])){
	if(@$_GET['q']== 'rmquiz' && $_SESSION['key']=='admin1234') {
		$eid=@$_GET['eid'];
...
//add quiz
if(isset($_SESSION['key'])){
	if(@$_GET['q']== 'addquiz' && $_SESSION['key']=='admin1234') {
		$name = $_POST['name'];
...
//add question
if(isset($_SESSION['key'])){
	if(@$_GET['q']== 'addqns' && $_SESSION['key']=='admin1234') {
		$n=@$_GET['n'];
		$eid=@$_GET['eid'];
		$ch=@$_GET['ch'];
...
if(@$_GET['q']== 'quiz' && @$_GET['step']== 2) {
	...
	else if( $_SESSION['key']!='admin1234')
	{

...
<head>
  ...
  <title>Project || Online Exam </title>
  ...
  <script>
    ...
    {var y = document.forms["form"]["name"].value;	var letters = /^[A-Za-z]+$/;if (y == null || y == "") 
      {alert("Name must be filled out.");return false;}var z =document.forms["form"]["college"].value;if (z == null || z == "")
    ...
    var a = document.forms["form"]["password"].value;if(a == null || a == "")
      {alert("Password must be filled out");return false;}if(a.length<5 || a.length>25)
      {alert("Passwords must be 5 to 25 characters long.");return false;}
    var b = document.forms["form"]["cpassword"].value;if (a!=b)
    ...
    <div class="row">
      ...
      <div class="row footer">
        <div class="col-md-3 box">
          <a href="https://nibm.lk/about-us-new/" target="_blank">About us</a>
        </div>
        <div class="col-md-3 box">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <p>
                      <div class="row">
                        <div class="col-md-4">
                         <img src="image/111.jpg" width=100 height=100 alt="Sunny Prakash Tiwari" class="img-rounded">
                       </div>
                       <div class="col-md-5">
                       
                        <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+94 715158902</h4>
                        <h4 style="font-family:'typo' ">Software engineering team </h4>
                        <h4 style="font-family:'typo' ">NIBM</h4></div></div>
                      </p>
                    </div>
